...
(architecture / risk buy-down / spike — whose deliverable is a `docs/concepts/REQ-NNN.md` doc or a
`docs/concepts/REQ-NNN/` bundle directory, optionally a committed prototype, REQ-039/REQ-067)
