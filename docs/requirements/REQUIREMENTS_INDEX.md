...
| REQ-075 | Per-AC revalidation — revalidate re-opens only the red ACs, carries green one-off evidence forward, and the engine hands the evidence dir to the grading tests | DRAFT | [REQ-075](REQ-075.md) | REQ-034, REQ-055, REQ-068, REQ-072 |
