...
| REQ-089 | The remote-host deployment seam — attended mid-phase push, a read-only land-gate preview, rework that carries prior sign-offs, and a flat discoverable CLI | DRAFT | [REQ-089](REQ-089.md) | REQ-030, REQ-033, REQ-055, REQ-063, REQ-071, REQ-075, REQ-081 |
