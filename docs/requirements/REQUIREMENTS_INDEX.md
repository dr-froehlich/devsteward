...
| REQ-028 | Gating integrity — skip isn't green, the named behaviour must run, verifier uses project venv + full suite, lint reconciles marker↔ledger | OPEN | [REQ-028](REQ-028.md) | REQ-002, REQ-006, REQ-015 |
