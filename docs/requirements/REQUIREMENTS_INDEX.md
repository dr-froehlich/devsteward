...
| REQ-064 | Intake screens environment-bound `regression` ACs — route by oracle coupling so a green can't silently become a skip | DRAFT | [REQ-064](REQ-064.md) | REQ-027 |
