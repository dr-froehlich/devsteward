...
| REQ-093 | A backlog of user needs above the REQ — capture in the user's words, take items up at intake, and record an acceptance verdict the REQ cannot overrule | OPEN | [REQ-093](REQ-093.md) | REQ-027, REQ-071, REQ-084, REQ-086, REQ-089 |
