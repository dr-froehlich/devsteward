...
| REQ-091 | A spawn never hides its model — surface the unset model, refuse it headless, and migrate the stamped consumers REQ-090 left behind | DRAFT | [REQ-091](REQ-091.md) | REQ-029, REQ-030, REQ-036, REQ-080, REQ-090 |
