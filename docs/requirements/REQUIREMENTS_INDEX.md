...
| REQ-084 | The doc layout is the consumer's, not the engine's — config seams for plans_dir/concepts_dir honored by the gates, the stamp and the stamped skills; and the operator-only onboard skill leaves the stamped set | DRAFT | [REQ-084](REQ-084.md) | REQ-024, REQ-029, REQ-036, REQ-039, REQ-066 |
