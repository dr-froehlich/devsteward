...
| REQ-052 | Post-REQ-047 cleanup — code + skill review for stale/bent legacy, with a sign-off report | IN-PROGRESS | [REQ-052](REQ-052.md) | REQ-047 |
| REQ-053 | Process resilience — every red step has an available forward path; audit the rework-vs-repeat model | DRAFT | [REQ-053](REQ-053.md) | REQ-047 |
