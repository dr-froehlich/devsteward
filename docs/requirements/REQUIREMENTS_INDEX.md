...
| REQ-065 | Validate pre-flight gate + steward reland — formality checks before the session, recovery without re-validation | DRAFT | [REQ-065](REQ-065.md) | REQ-029, REQ-039, REQ-056 |
| REQ-066 | sync covers STEWARD.md — track every engine-owned stamped artifact, not just skills | DRAFT | [REQ-066](REQ-066.md) | REQ-024, REQ-036, REQ-057 |
