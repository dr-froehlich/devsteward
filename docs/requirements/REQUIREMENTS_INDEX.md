...
| REQ-034 | Human validation as a guided, asynchronous activity — interactive System-Tester session, QA-ticket parking, clean re-entry | DRAFT | [REQ-034](REQ-034.md) | REQ-020, REQ-030, REQ-032, REQ-033 |
| REQ-035 | Re-validating a done REQ leaves verified_by frozen — provenance is not clobbered | DRAFT | [REQ-035](REQ-035.md) | REQ-030 |
