...
| REQ-081 | Warm validation cycle — steward validate start/record as real CLI verbs, the verdict recorded from a second shell, the System-Tester session survives a red through rework | DRAFT | [REQ-081](REQ-081.md) | REQ-030, REQ-033, REQ-034, REQ-055, REQ-075 |
