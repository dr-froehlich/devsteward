...
machine-readable contract, a frozen `REQ-001` north star, a dependency-ordered roadmap,
and an attended/unattended automation loop that walks the work and only marks a step
...
derives those steps from REQ/ROADMAP files as a Design → Build → Land cycle.
